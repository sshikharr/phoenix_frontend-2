...
const LuxuryProducts = lazy(() => import("./Pages/Collection/LuxuryProducts.jsx"));
...
const ExecutiveProducts = lazy(() => import("./Pages/Collection/ExecutiveProducts.jsx"));
// Add Product
const AddProduct = lazy(() => import("./AddProduct"));
const AddCategory = lazy(() => import("./AddCategory.jsx"));
// Support Needs
const NeckSupport = lazy(() => import("./Pages/ShopBy/Support Need/NeckSupport"));
const ActiveSupport = lazy(() => import("./Pages/ShopBy/Support Need/ActiveSupport"));
const Posture = lazy(() => import("./Pages/ShopBy/Support Need/Posture"));
const LumbarSupport = lazy(() => import("./Pages/ShopBy/Support Need/LumbarSupport"));
// Price
...
const LumbarPillow = lazy(() => import("./Pages/ShopBy/Features/LumbarPillow.jsx"));
const MetalBase = lazy(() => import("./Pages/ShopBy/Features/MetalBase.jsx"));
// Best Sellers
const ErgonomicChairs = lazy(() => import("./Pages/ShopBy/Best Sellers/ErgonomicChairs.jsx"));
const ErgonomicChairsPro = lazy(() => import("./Pages/ShopBy/Best Sellers/ErgonomicChairsPro.jsx"));
const VerveChairs = lazy(() => import("./Pages/ShopBy/Best Sellers/VerveChairs.jsx"));
const TaskChairs = lazy(() => import("./Pages/ShopBy/Best Sellers/TaskChairs.jsx"));
// New Arrivals
const AireChairs = lazy(() => import("./Pages/ShopBy/New Arrivals/AireChairs.jsx"));
